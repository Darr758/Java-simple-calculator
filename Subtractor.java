/**
* This class implements the BinaryOperations interface and defines the apply method for Subtractor.
*
* @author Darragh King (ID 113372871)
*/

public class Subtractor implements BinaryOperations{
	/**
	*	Overrides apply to be used for Subtract.
	*
